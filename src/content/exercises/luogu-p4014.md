...
statement: |-
  將 n 件工作一對一分給 n 人，分別求總效益最小值與最大值。
constraints:
  - '完整資料範圍以已核實的外部題面為準'
...
core_knowledge: ['最小費用最大流', '指派問題']
judgment: |-
  人到工作容量皆為一；最大值可把效益取負後再求最小費。
hints:
  - '先辨識核心轉換：最小費用最大流、指派問題。'
  - '人到工作容量皆為一；最大值可把效益取負後再求最小費。'
  - '依「建源→人→工作→匯的單位容量網路，分別以 c 與 -c 跑滿 n 單位流。」實作，並特別檢查容量、反向邊、索引與輸出還原。'
solution_outline: |-
  建源→人→工作→匯的單位容量網路，分別以 c 與 -c 跑滿 n 單位流。
proof_or_invariant: |-
  整數滿流分解成一個完美匹配，反之每個指派都是滿流；費用相等，故最小費流給出兩個極值。
common_errors:
...
external_url: https://www.luogu.com.cn/problem/P4014
external_platform: '洛谷'
external_problem_id: 'P4014'
external_title: '分配問題'
