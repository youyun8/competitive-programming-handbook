...
original_label: '洛谷 P4016'
title: '洛谷 P4016 負載平衡問題'
chapter: 10
section: '10.13'
kind: external-oj
difficulty: 3
...
core_knowledge: ['環上平衡', '前綴和中位數']
judgment: |-
  總量必可整除 n；切開環後各邊淨流量只差同一常數。
hints:
  - '先辨識核心轉換：環上平衡、前綴和中位數。'
  - '總量必可整除 n；切開環後各邊淨流量只差同一常數。'
  - '依「令前綴失衡 s[i] 累加 a[i]-avg，選其中位數 med，答案為 Σ|s[i]-med|。」實作，並特別檢查容量、反向邊、索引與輸出還原。'
solution_outline: |-
  令前綴失衡 s[i] 累加 a[i]-avg，選其中位數 med，答案為 Σ|s[i]-med|。
proof_or_invariant: |-
  任一方案在第 i 條邊的淨流量為 s[i]-x；總搬運下界為絕對值和，而中位數使其最小且可依淨流實現。
common_errors:
...
external_url: https://www.luogu.com.cn/problem/P4016
external_platform: '洛谷'
external_problem_id: 'P4016'
external_title: '負載平衡問題'
