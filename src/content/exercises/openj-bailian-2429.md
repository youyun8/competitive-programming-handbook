...
source_pdf_pages:
  - 17
  - 91
title: OpenJ_Bailian 2429 GCD & LCM Inverse
chapter: 6
section: '6.7'
kind: external-oj
difficulty: 3
...
prerequisites:
  - 整除與模運算
statement: 給定 GCD 與 LCM，找出 gcd 為 GCD、lcm 為 LCM 且差最小的兩個正整數。
constraints:
  - 1<=GCD<=LCM<=2*10^9
...
cpp_skeleton: |
  ...
  #include <bits/stdc++.h>
  using namespace std;
  int main(){long long g,l;while(cin>>g>>l){long long r=l/g,b=1;for(long long d=1;d<=r/d;++d)if(r%d==0&&gcd(d,r/d)==1)b=d;cout<<g*b<<' '<<g*(r/b)<<"\n";}}
cpp_solution: |
  #include <bits/stdc++.h>
  using namespace std;
  int main(){long long g,l;while(cin>>g>>l){long long r=l/g,b=1;for(long long d=1;d<=r/d;++d)if(r%d==0&&gcd(d,r/d)==1)b=d;cout<<g*b<<' '<<g*(r/b)<<"\n";}}
external_url: http://bailian.openjudge.cn/practice/2429/
external_platform: OpenJ_Bailian
external_problem_id: '2429'
external_title: GCD & LCM Inverse
