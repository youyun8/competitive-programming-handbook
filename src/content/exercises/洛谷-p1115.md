...
cpp_solution: |
  #include <bits/stdc++.h>
  using namespace std;int main(){ios::sync_with_stdio(false);cin.tie(nullptr);int n;cin>>n;long long cur=LLONG_MIN,ans=LLONG_MIN;while(n--){long long x;cin>>x;cur=cur==LLONG_MIN?x:max(x,cur+x);ans=max(ans,cur);}cout<<ans<<'\n';return 0;}
external_url: https://www.luogu.com.cn/problem/P1115
external_platform: 洛谷
external_problem_id: 'P1115'
external_title: '最大子段和'
